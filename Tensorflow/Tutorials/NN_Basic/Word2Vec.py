...
font_name = matplotlib.font_manager.FontProperties(
                fname='F:/2018_Spring/Programming/Python/Tensorflow/Font/H2GTRE.ttf'  # 한글 폰트 위치를 넣어주세요
            ).get_name()
...
sentences2 = ["나 고양이 좋다",
             ...
             "고양이 강아지 싫다",
             "강아지 고양이 좋다",
             "오늘 날씨 정말 좋다 밖에 나가 놀고 싶다",
             "날씨 정말 좋다 오늘 나가서 놀고 싶어 미치겠다"]

sentences = ["나는 피자가 제일 좋다",
             "피자는 내가 제일 좋아하는 음식이다",
             "문장이 더 필요한가보다",
             "문장을 더 만들어야겠다",
             "다섯개 정도면 충분할까?"]
